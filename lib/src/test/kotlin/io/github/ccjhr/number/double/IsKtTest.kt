...
internal class IsKtTest {
    ...
    internal class OddTests {
        ...
        fun `fails for even value`() {
            ...
            // then
            assertEquals("Expecting <12.0> to be odd, but it's even.", result.message)
        }
    ...
    internal class EvenTests {
        ...
        fun `fails for odd value`() {
            ...
            // then
            assertEquals("Expecting <11.0> to be even, but it's odd.", result.message)
        }
    ...
    internal class PositiveTests {
        ...
        fun `fails for negative value`() {
            ...
            // then
            assertEquals("Expecting <-12.0> to be positive, but it's negative.", result.message)
        }
    ...
    internal class NegativeTests {
        ...
        fun `fails for positive value`() {
            ...
            // then
            assertEquals("Expecting <12.0> to be negative, but it's positive.", result.message)
        }
